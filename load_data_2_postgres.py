...
wireless_df = pd.read_csv('https://s3.amazonaws.com/amazon-reviews-pds/tsv/amazon_reviews_us_Wireless_v1_00.tsv.gz')
...
# # load df to database
wireless_df.to_sql('wireless',engine,index=False,if_exists='append')
# print('departments')
